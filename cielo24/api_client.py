...
from cielo24 import rest
from cielo24.configuration import Configuration
from cielo24.exceptions import ApiTypeError, ApiValueError, ApiException
from cielo24.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_settings  # this is an instance of the class Endpoint
        api_instance.get_settings()  # this invokes api_instance.get_settings.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_settings.callable or self.callable in this class
